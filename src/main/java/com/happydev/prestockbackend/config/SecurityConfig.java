    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .authorizeHttpRequests(authz -> authz
                        ...
                        .requestMatchers("/api/users/**").hasAnyRole("ADMIN", "GESTOR")
                        .requestMatchers("/api/audit-logs/**").hasAnyRole("ADMIN", "GESTOR")
                        .requestMatchers("/api/admin/**").hasAnyRole("ADMIN", "GESTOR")
                        .requestMatchers(HttpMethod.GET, "/api/modules/flags").authenticated()
                        .requestMatchers(HttpMethod.PUT, "/api/modules/flags").hasAnyRole("ADMIN", "GESTOR")
