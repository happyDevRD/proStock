...
@Configuration
@EnableConfigurationProperties({JwtProperties.class, CookieProperties.class, LoginSecurityProperties.class, TotpProperties.class, PasswordPolicyProperties.class})
